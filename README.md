...
```
curl -sL "https://raw.githubusercontent.com/rmnscnce/Revancify/refactor-use-hardlinks-personal/install.sh" | bash
```
...
<details>
  ...
  ```
pkg update -y -o Dpkg::Options::="--force-confnew" && pkg install git -y && git clone -b refactor-use-hardlinks-personal --depth=1 https://github.com/rmnscnce/Revancify.git && ./Revancify/revancify
```
</details>
